...
set output '../picture_saved/11_3p2.eps'
...
set terminal postscript eps color enhanced solid "Time-Roman,30"
set output '../picture_saved/11_3f2.eps'
set xlabel 'K_c_._m_.[MeV]'
set xtics 100
set mxtics 4
set ylabel '{/Symbol d} [deg]'
...
set terminal postscript eps color enhanced solid "Time-Roman,30"
set output '../picture_saved/11_3p1.eps'
set xlabel 'K_c_._m_.[MeV]'
set xtics 100
set mxtics 4
set ylabel '{/Symbol d} [deg]'
...
chn = "1p1"
lmbd = "0800"
plot '../empirical_value/1p1.nij' using 1:3 title 'empirical value' pt 7 ps 1.5, 'set_11/run_'.chn.'_lmbd_'.lmbd.'.out' using 1:4 title 'UpToQn=1' w l linestyle 0 lc 3 lw 3, 'set_11/run_'.chn.'_lmbd_'.lmbd.'.out' using 1:5 title 'UpToQn=2' with line dashtype 4 lc 2 lw 3, 'set_11/run_'.chn.'_lmbd_'.lmbd.'.out' using 1:6 title 'UpToQn=3' with line dashtype 5 lc 4 lw 3, 'set_11/run_'.chn.'_lmbd_'.lmbd.'.out' using 1:7 title 'UpToQn=4' w l lt 7 lw 3 
reset

#1d2

set terminal postscript eps color enhanced solid "Time-Roman,30"
set output '../picture_saved/11_1d2.eps'
set xlabel 'K_c_._m_.[MeV]'
set xtics 100
set mxtics 4
set ylabel '{/Symbol d} [deg]'
...
set terminal postscript eps color enhanced solid "Time-Roman,30"
set output '../picture_saved/11_3d2.eps'
set xlabel 'K_c_._m_.[MeV]'
set xtics 100
set mxtics 4
set ylabel '{/Symbol d} [deg]'
...
set terminal postscript eps color enhanced solid "Time-Roman,30"
set output '../picture_saved/11_3d3.eps'
set xlabel 'K_c_._m_.[MeV]'
set xtics 100
set mxtics 4
set ylabel '{/Symbol d} [deg]'
...
set terminal postscript eps color enhanced solid "Time-Roman,30"
set output '../picture_saved/11_3g3.eps'
set xlabel 'K_c_._m_.[MeV]'
set xtics 100
set mxtics 4
set ylabel '{/Symbol d} [deg]'
...
set terminal postscript eps color enhanced solid "Time-Roman,30"
set output '../picture_saved/11_e3.eps'
set xlabel 'K_c_._m_.[MeV]'
set xtics 100
set mxtics 4
set ylabel 'Mixing angle [deg]'
...
set terminal postscript eps color enhanced solid "Time-Roman,30"
set output '../picture_saved/11_1f3.eps'
set xlabel 'K_c_._m_.[MeV]'
set xtics 100
set mxtics 4
set ylabel '{/Symbol d} [deg]'
...
chn = "1f3"
lmbd = "0800"
plot '../empirical_value/1f3.nij' using 1:3 title 'empirical value' pt 7 ps 1.5, 'set_11/run_'.chn.'_lmbd_'.lmbd.'.out' using 1:4 title 'UpToQn=1' w l linestyle 0 lc 3 lw 3, 'set_11/run_'.chn.'_lmbd_'.lmbd.'.out' using 1:5 title 'UpToQn=2' with line dashtype 4 lc 2 lw 3, 'set_11/run_'.chn.'_lmbd_'.lmbd.'.out' using 1:6 title 'UpToQn=3' with line dashtype 5 lc 4 lw 3, 'set_11/run_'.chn.'_lmbd_'.lmbd.'.out' using 1:7 title 'UpToQn=4' w l lt 7 lw 3 
reset

#3f3

set terminal postscript eps color enhanced solid "Time-Roman,30"
set output '../picture_saved/11_3f3.eps'
set xlabel 'K_c_._m_.[MeV]'
set xtics 100
set mxtics 4
set ylabel '{/Symbol d} [deg]'
...
chn = "3f3"
lmbd = "0800"
plot '../empirical_value/3f3.nij' using 1:3 title 'empirical value' pt 7 ps 1.5, 'set_11/run_'.chn.'_lmbd_'.lmbd.'.out' using 1:4 title 'UpToQn=1' w l linestyle 0 lc 3 lw 3, 'set_11/run_'.chn.'_lmbd_'.lmbd.'.out' using 1:5 title 'UpToQn=2' with line dashtype 4 lc 2 lw 3, 'set_11/run_'.chn.'_lmbd_'.lmbd.'.out' using 1:6 title 'UpToQn=3' with line dashtype 5 lc 4 lw 3, 'set_11/run_'.chn.'_lmbd_'.lmbd.'.out' using 1:7 title 'UpToQn=4' w l lt 7 lw 3 
reset

#3f4

set terminal postscript eps color enhanced solid "Time-Roman,30"
set output '../picture_saved/11_3f4.eps'
set xlabel 'K_c_._m_.[MeV]'
set xtics 100
set mxtics 4
set ylabel '{/Symbol d} [deg]'
...
chn = "3f4"
lmbd = "0800"
plot '../empirical_value/3f4.nij' using 1:3 title 'empirical value' pt 7 ps 1.5, 'set_11/run_'.chn.'_lmbd_'.lmbd.'.out' using 1:6 title 'UpToQn=1' w l linestyle 0 lc 3 lw 3, 'set_11/run_'.chn.'_lmbd_'.lmbd.'.out' using 1:9 title 'UpToQn=2' with line dashtype 4 lc 2 lw 3, 'set_11/run_'.chn.'_lmbd_'.lmbd.'.out' using 1:12 title 'UpToQn=3' with line dashtype 5 lc 4 lw 3, 'set_11/run_'.chn.'_lmbd_'.lmbd.'.out' using 1:15 title 'UpToQn=4' w l lt 7 lw 3 
reset

#3h4

set terminal postscript eps color enhanced solid "Time-Roman,30"
set output '../picture_saved/11_3h4.eps'
set xlabel 'K_c_._m_.[MeV]'
set xtics 100
set mxtics 4
set ylabel '{/Symbol d} [deg]'
...
chn = "3f4"
lmbd = "0800"
plot '../empirical_value/3h4.nij' using 1:3 title 'empirical value' pt 7 ps 1.5, 'set_11/run_'.chn.'_lmbd_'.lmbd.'.out' using 1:7 title 'UpToQn=1' w l linestyle 0 lc 3 lw 3, 'set_11/run_'.chn.'_lmbd_'.lmbd.'.out' using 1:10 title 'UpToQn=2' with line dashtype 4 lc 2 lw 3, 'set_11/run_'.chn.'_lmbd_'.lmbd.'.out' using 1:13 title 'UpToQn=3' with line dashtype 5 lc 4 lw 3, 'set_11/run_'.chn.'_lmbd_'.lmbd.'.out' using 1:16 title 'UpToQn=4' w l lt 7 lw 3 
reset

#e4

set terminal postscript eps color enhanced solid "Time-Roman,30"
set output '../picture_saved/11_e4.eps'
set xlabel 'K_c_._m_.[MeV]'
set xtics 100
set mxtics 4
set ylabel 'Mixing angle [deg]'
...
chn = "3f4"
lmbd = "0800"
plot '../empirical_value/e4.nij' using 1:3 title 'empirical value' pt 7 ps 1.5, 'set_11/run_'.chn.'_lmbd_'.lmbd.'.out' using 1:8 title 'UpToQn=1' w l linestyle 0 lc 3 lw 3, 'set_11/run_'.chn.'_lmbd_'.lmbd.'.out' using 1:11 title 'UpToQn=2' with line dashtype 4 lc 2 lw 3, 'set_11/run_'.chn.'_lmbd_'.lmbd.'.out' using 1:14 title 'UpToQn=3' with line dashtype 5 lc 4 lw 3, 'set_11/run_'.chn.'_lmbd_'.lmbd.'.out' using 1:17 title 'UpToQn=4' w l lt 7 lw 3 
reset

#1g4

set terminal postscript eps color enhanced solid "Time-Roman,30"
set output '../picture_saved/11_1g4.eps'
set xlabel 'K_c_._m_.[MeV]'
set xtics 100
set mxtics 4
set ylabel '{/Symbol d} [deg]'
...
chn = "1g4"
lmbd = "0800"
plot '../empirical_value/1g4.nij' using 1:3 title 'empirical value' pt 7 ps 1.5, 'set_11/run_'.chn.'_lmbd_'.lmbd.'.out' using 1:4 title 'UpToQn=1' w l linestyle 0 lc 3 lw 3, 'set_11/run_'.chn.'_lmbd_'.lmbd.'.out' using 1:5 title 'UpToQn=2' with line dashtype 4 lc 2 lw 3, 'set_11/run_'.chn.'_lmbd_'.lmbd.'.out' using 1:6 title 'UpToQn=3' with line dashtype 5 lc 4 lw 3, 'set_11/run_'.chn.'_lmbd_'.lmbd.'.out' using 1:7 title 'UpToQn=4' w l lt 7 lw 3 
reset

#3g4

set terminal postscript eps color enhanced solid "Time-Roman,30"
set output '../picture_saved/11_3g4.eps'
set xlabel 'K_c_._m_.[MeV]'
set xtics 100
set mxtics 4
set ylabel '{/Symbol d} [deg]'
...
chn = "3g4"
lmbd = "0800"
plot '../empirical_value/3g4.nij' using 1:3 title 'empirical value' pt 7 ps 1.5, 'set_11/run_'.chn.'_lmbd_'.lmbd.'.out' using 1:4 title 'UpToQn=1' w l linestyle 0 lc 3 lw 3, 'set_11/run_'.chn.'_lmbd_'.lmbd.'.out' using 1:5 title 'UpToQn=2' with line dashtype 4 lc 2 lw 3, 'set_11/run_'.chn.'_lmbd_'.lmbd.'.out' using 1:6 title 'UpToQn=3' with line dashtype 5 lc 4 lw 3, 'set_11/run_'.chn.'_lmbd_'.lmbd.'.out' using 1:7 title 'UpToQn=4' w l lt 7 lw 3 
reset

#3g5

set terminal postscript eps color enhanced solid "Time-Roman,30"
set output '../picture_saved/11_3g5.eps'
set xlabel 'K_c_._m_.[MeV]'
set xtics 100
set mxtics 4
set ylabel '{/Symbol d} [deg]'
...
chn = "3g5"
lmbd = "0800"
plot '../empirical_value/3g5.nij' using 1:3 title 'empirical value' pt 7 ps 1.5, 'set_11/run_'.chn.'_lmbd_'.lmbd.'.out' using 1:6 title 'UpToQn=1' w l linestyle 0 lc 3 lw 3, 'set_11/run_'.chn.'_lmbd_'.lmbd.'.out' using 1:9 title 'UpToQn=2' with line dashtype 4 lc 2 lw 3, 'set_11/run_'.chn.'_lmbd_'.lmbd.'.out' using 1:12 title 'UpToQn=3' with line dashtype 5 lc 4 lw 3, 'set_11/run_'.chn.'_lmbd_'.lmbd.'.out' using 1:15 title 'UpToQn=4' w l lt 7 lw 3 
reset