...
! Class obj_woc0_taylor_sngl (Single channels where OPE is nonperturbative but
! C0 is not at LO.)
! Still under construction 01/14/2014

! Abandoned, 07/14/2018
module mod_obj_woc0_taylor_sngl

    use mod_obj_taylor_sngl
    implicit none

    type, extends(obj_taylor_sngl) :: obj_woc0_taylor_sngl

        type(vstruct_sngl)  :: vs_ope, vs_2pi0, vs_dummy, vs_nlo, vs_poly0

    contains

        procedure   :: init                 => init_woc0_taylor_sngl
        procedure   :: release              => release_woc0_taylor_sngl
        procedure   :: get_paras_filename  => get_paras_filename_woc0_taylor_sngl
        procedure   :: update_k             => update_k_woc0_taylor_sngl
!         procedure   :: get_num_paras       => get_num_paras_woc0_taylor_sngl
        procedure   :: get_allTQn           => get_allTQn_woc0_taylor_sngl

    end type obj_woc0_taylor_sngl


contains


    subroutine init_woc0_taylor_sngl(self, N, regtype, Mambda, Lambda)

        class(obj_woc0_taylor_sngl), intent(inout)  :: self
    ...
    end subroutine init_woc0_taylor_sngl


    subroutine release_woc0_taylor_sngl(self)
    ...
    end subroutine release_woc0_taylor_sngl


    subroutine get_paras_filename_woc0_taylor_sngl(self, fname)
    ...
    end subroutine get_paras_filename_woc0_taylor_sngl


    subroutine update_k_woc0_taylor_sngl(self, k)
    ...
    end subroutine update_k_woc0_taylor_sngl


    subroutine get_allTQn_woc0_taylor_sngl(self)
    ...
    end subroutine get_allTQn_woc0_taylor_sngl


end module mod_obj_woc0_taylor_sngl
