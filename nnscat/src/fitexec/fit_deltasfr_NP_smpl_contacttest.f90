...
program fit_deltasfr_NP_smpl_contacttest
...
!   npar_Qn(1:4) = npar_withc0_sngl(1:4)
    ...
    errmsg = 'fit_deltasfr_NP_smpl_contacttest: Something went wrong'

  call init_smpl
  call PrintOutFitSngl_fitting(GetNPSngl_smpl_fitdeltasfr,                         &
...
case default
  ...
  call PrintOutFitCpld_fitting(GetNPcpld_smpl_fitdeltasfr, fitphs1_fname,      &
...
contains
  ...
  subroutine GetNPSngl_smpl_fitdeltasfr(Nmesh, Mambda, chnid, uptoQn, paralst,      &
...
!     call SetUpVfunc_withc0_smpl(chn)
  ...
  end subroutine GetNPSngl_smpl_fitdeltasfr

  subroutine GetNPcpld_smpl_fitdeltasfr(Nmesh, Mambda, chnid, uptoQn, paralst,      &
    & num_paras, klist, numk, phaselst)
...
!     call SetUpVfunc_withc0_smpl(chn)
  ...
  end subroutine GetNPcpld_smpl_fitdeltasfr

end program fit_deltasfr_NP_smpl_contacttest