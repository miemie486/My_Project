...
select case(trim(cmdstr))
  ...
  errmsg = 'fit_supsfr_chn: Something went wrong'

  call PrintOutFitcpld_fitting(GetPS_cpld_deltaless,                         &
  ...
  call PrintOutFitSngl_fitting(GetPs_sngl_deltaless,                         &
