! Bingwei July 29, 2018
! pray 26/12/2018

program fit_nonperdelta_3s1
  ...
  call PrintOutFitCpld_fitting(GetNPCpld_smpl_fitdelta3s1, fitphs1_fname,      &
...
contains
  ...
  subroutine GetNPCpld_smpl_fitdelta3s1(Nmesh, Mambda, chnid, uptoQn, paralst, &
  ...
  end subroutine GetNPCpld_smpl_fitdelta3s1

end program fit_nonperdelta_3s1
