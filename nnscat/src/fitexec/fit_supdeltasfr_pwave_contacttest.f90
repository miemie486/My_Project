...
program fit_supdeltasfr_pwave_contacttest
...
select case(trim(cmdstr))
  case('3p2')
    ...
    errmsg = 'fit_supdeltasfr_pwave_contacttest: Something went wrong'

    call PrintOutFitcpld_fitting(Getsfrdeltacpld_smpl_test_fitpwa,                         &
  ...
  case default
    ...
    call PrintOutFitSngl_fitting(Getsfrdeltasngl_smpl_test_fitpwa,                         &
...
contains
  ...
  subroutine Getsfrdeltasngl_smpl_test_fitpwa(Nmesh, Mambda, chnid, uptoQn, paralst,      &
    ...
    call SetUp_pope_del_SFR_smpl_test(ptrchn)
  ...
  end subroutine Getsfrdeltasngl_smpl_test_fitpwa

  subroutine Getsfrdeltacpld_smpl_test_fitpwa(Nmesh, Mambda, chnid, uptoQn, paralst,      &
    & num_paras, klist, numk, phaselst)
  ...
  end subroutine Getsfrdeltacpld_smpl_test_fitpwa

end program fit_supdeltasfr_pwave_contacttest