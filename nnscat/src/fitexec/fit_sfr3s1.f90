...
program fit_sfr3s1
  ...
  call PrintOutFitCpld_fitting(GetNPCpldSfr_smpl_fit3s1, fitphs1_fname,      &
...
!     chn%V3_cheb_bnd = 1.0E-3_NER
  ...
  subroutine GetNPCpldSfr_smpl_fit3s1(Nmesh, Mambda, chnid, uptoQn, paralst, &
  ...
  end subroutine GetNPCpldSfr_smpl_fit3s1
end program fit_sfr3s1
