...
select case(trim(cmdstr))
  ...
  errmsg = 'fit_supdeltasfr_chn: Something went wrong'

  call PrintOutFitcpld_fitting(GetPS_cpld_delta,                         &
  ...
  call PrintOutFitSngl_fitting(GetPs_sngl_delta,                         &
 ...
 end program fit_supdeltasfr_chn
