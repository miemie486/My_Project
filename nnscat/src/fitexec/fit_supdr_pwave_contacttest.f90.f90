...
program fit_supdr_pwave_contacttest
...
select case(trim(cmdstr))
  case('3p2')
    ...
    errmsg = 'fit_supdr_pwave_contacttest: Something went wrong'

    call PrintOutFitcpld_fitting(Getdrcpld_smpl_test_fitpwa,                         &
  ...
  case default
    ...
    call PrintOutFitSngl_fitting(Getdrsngl_smpl_test_fitpwa,                         &
...
contains
  ...
  subroutine Getdrsngl_smpl_test_fitpwa(Nmesh, Mambda, chnid, uptoQn, paralst,      &
    ...
    call SetUp_pope_DR_smpl_test(ptrchn)
  ...
  end subroutine Getdrsngl_smpl_test_fitpwa

  subroutine Getdrcpld_smpl_test_fitpwa(Nmesh, Mambda, chnid, uptoQn, paralst,      &
    & num_paras, klist, numk, phaselst)
  ...
  end subroutine Getdrcpld_smpl_test_fitpwa

end program fit_supdr_pwave_contacttest