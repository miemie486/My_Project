...
contains
  ...
  subroutine get_timestring_hms ( string )
  ...
  !
    ...
    write ( string, '(a,1x,i2.2, a, 1x,i4,2x,i2,a1,i2.2,a1,i2.2,a1,i3.3,1x,a)' ) &
      trim ( month(m) ), d, ',', y, h, ':', n, ':', s, '.', mm, trim ( ampm )
    return
  end subroutine get_timestring_hms


  subroutine get_current_time_hms ( h, m, s, mm )
  ...
  !
    ...
    mm = values(8)
    return
  end subroutine get_current_time_hms

  subroutine print_current_time_hms ( string )
  ...
  !
    ...
    call get_current_time_string ( string2 )

    write ( *, '(a,2x,a,2x,a)' ) 'Wallclock:', string2, trim ( string )

    return
  end subroutine print_current_time_hms

  subroutine get_current_time_string ( string )
  ...
  subroutine print_delta_hms ( string )
  ...
  !
    if ( h == -1 ) then
      ...
      call get_current_time_hms ( h, m, s, mm )
    ...
    write ( *, '(a,i2,a1,i2.2,a1,i2.2,a1,i3.3,2x,a)' ) &
      ...
      trim ( string )
    return
  end subroutine print_delta_hms

  subroutine print_timestamp_hms ( )
  ...
  !
    ...
    return
  end subroutine print_timestamp_hms

end module util_datetime
