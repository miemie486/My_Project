...
#f1=open("20230613 9 cell 1.3GHz_freq_pi mode_35500_100_avg on_3 span500 kHz")
f1=open("20230613_6_Fourier_filter_data.csv")
...
f_out=open('cache20230613_3.csv','w', newline='')
