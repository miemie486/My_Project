...
#f1=open("20230418 9 cell 1.3GHz_phase_pi mode_35500_100_avg on_sm on_4 span500 kHz")
f1=open("20230418_4_Fourier_filter_data.csv")
...
f_out=open('20230418_4_1.csv','w', newline='')
