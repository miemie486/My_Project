...
#f1=open("20230915 9 cell 1.3GHz_phase_pi mode_35500_100_avg on_sm on_1 span500 kHz-2")
f1=open("20230919_phase2_Fourier_filter_data.csv")
...
f_out=open('11cache20230919_phase2.csv','w', newline='')
