...
#f1=open("20230425 9 cell 1.3GHz_phase_pi mode_35500_100_avg on_sm on_1_2 span500 kHz")
f1=open("20230425_1_2_Fourier_filter_data.csv")
...
f_out=open('cache20230423_1.csv','w', newline='')
