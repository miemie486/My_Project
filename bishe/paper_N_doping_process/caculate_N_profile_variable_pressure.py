...
if __name__ == "__main__":
    ...
    for i in range(1,31):
        doping_and_baking_time.append([i,20])
    ...
    for j in pressure_list:
        for i in doping_and_baking_time:
            ...
            parameters=[800+273,j,C_N,2.79e25,2.46e28,N_x,N_doping_time,doping_time,6.8*10**-14]
            ...
            #baking 过程
            if(i[0]==0):
                name="data\data_800_"+str(i[0])+"N"+str(i[1])+"_min_"+str(j)+"Pa_theory"
                ...
                name="data\\variable_pressure_N2A6\\data_800_"+str(i[0])+"N"+str(i[1])+"_min_"+str(j)+"Pa_theory"
