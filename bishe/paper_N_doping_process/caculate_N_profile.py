...
if __name__ == "__main__":
    ...
    #doping_and_baking_time=[[0.2,20],[0.4,20],[0.6,20],[0.8,20],[1.5,20],[2.5,20],[3.5,20],[4.5,20]]
    doping_time_list=[0.2,0.4,0.6,0.8,1.5,2.5,3.5,4.5]+list(range(1,31))

    
    doping_and_baking_time=[]
    for j in [0,6,10,20]:
        for i in doping_time_list:
            doping_and_baking_time.append([i,j])
    print(doping_and_baking_time)
    
    for i in doping_and_baking_time:
        start_local = timer()
        #doping 过程
        doping_time=i[0]*60
        N_doping_time=doping_time*100
        ...
        #baking 过程
        if(i[0]==0):
            name="data\data_800_"+str(i[0])+"N"+str(i[1])+"min_theory"
            np.save(name,result[0])
        else:
            baking_time=i[1]*60
            ...
            name="data\_"+str(i[1])+"min baking\data_800_"+str(i[0])+"N"+str(i[1])+"min_theory"
