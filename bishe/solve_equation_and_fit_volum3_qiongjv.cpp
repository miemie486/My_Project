...
const double uppper_limit[6]={100.0e-9,100.0e-9,0.3/miu0,1.0e-7,10.0e-9,100.0e-9};
const double lower_limit[6]={1.0e-9,10.0e-9,0.15/miu0,10.0e-9,1.0e-10,10.0e-9};
...
int main()
{
  ...
  double best_position[6]={10e-7,23.0e-9,0.2/miu0,40.0e-9,3.0e-9,20.0e-9};
  ...
  {
    cout<<data[j][0]*miu0*1000<<" "<<Q(data[j][0],2)<<" "<<exp(-2*thickness_a/(lambda_L_T_H(2,data[j][0])*(1+xi_0/l_1)))<<endl;
  }
  cout<<best_position[0]<<" "<<best_position[1]<<" "<<best_position[2]<<" "<<best_position[3]<<" "<<best_position[4]<<" "<<best_position[5]<<" "<<best_fit<<endl;
  cout<<Rs1(2,0)<<" "<<Rs2(2,0)<<" "<<exp(-2*thickness_a/(lambda_L_T_H(2,0)*(1+xi_0/l_1)))<<endl;
  return 0;
}