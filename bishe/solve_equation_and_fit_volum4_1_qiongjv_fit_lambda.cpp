...
const double uppper_limit[dimension]={100.0e-9,1.0e-7,0.3/miu0,100.0e-9,100.0e-9,100.0e-9,100.0,100.0};
const double lower_limit[dimension]={1.0e-9,10.0e-9,0.15/miu0,10.0e-9,1.0e-9,10.0e-9,0.0,0.0};
